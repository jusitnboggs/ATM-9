...
ServerEvents.recipes(allthemods => {
    ...
    bathe('chalcopyrite', '128x #forge:raw_materials/chalcopyrite', 'gtceu:mercury', ['256x gtceu:chalcopyrite_dust', '256x alltheores:gold_dust'], ['128x gtceu:pyrite_dust', '128x gtceu:stone_dust', '256x gtceu:stone_dust', '256x gtceu:cobalt_dust', '256x gtceu:cadmium_dust'], [2800, 1100, 7900, 3300, 6500], [300, 100, 650, 0, 850], 1)
    bathe('chalcopyrite_silked', '128x #forge:ores/chalcopyrite', 'gtceu:mercury', ['512x gtceu:chalcopyrite_dust', '512x alltheores:gold_dust', '128x gtceu:stone_dust'], ['128x gtceu:pyrite_dust', '512x gtceu:stone_dust', '512x gtceu:cobalt_dust', '512x gtceu:cadmium_dust'], [6500, 7900, 3300, 6500], [850, 650, 0, 850], 2)
    ...
    sift('coal', '128x #forge:raw_materials/coal', 'minecraft:water', ['512x gtceu:stone_dust'], ['128x minecraft:coal', '128x gtceu:stone_dust', '512x gtceu:coal_dust', '512x gtceu:exquisite_coal_gem', '512x gtceu:flawless_coal_gem', '512x minecraft:coal', '512x gtceu:pure_coal_dust'], [2800, 1100, 3300, 900, 1900, 6500, 9500], [300, 100, 0, 100, 150, 500, 750], 2)
    sift('coal_silked', '128x #forge:ores/coal', 'minecraft:water', ['1152x gtceu:stone_dust'], ['128x minecraft:coal', '1024x gtceu:coal_dust', '1024x gtceu:exquisite_coal_gem', '1024x gtceu:flawless_coal_gem', '1024x minecraft:coal', '1024x gtceu:pure_coal_dust'], [2800, 3300, 900, 1900, 6500, 9500], [300, 100, 0, 100, 150, 500, 750], 4)
    ...
    // rock salt
    process('rock_salt', '128x #forge:raw_materials/rock_salt', 'minecraft:water', ['512x gtceu:rock_salt_dust', '512x gtceu:stone_dust'], ['128x gtceu:salt_gem', '128x gtceu:stone_dust', '512x gtceu:salt_dust', '512x gtceu:borax_dust', '512x gtceu:borax_dust'], [2800, 1100, 3300, 3300, 6500], [300, 100, 0, 0, 850], 2)
    process('rock_salt_silked', '128x #forge:ores/rock_salt', 'minecraft:water', ['1024x gtceu:rock_salt_dust', '1152x gtceu:stone_dust'], ['128x gtceu:salt_gem', '1024x gtceu:salt_dust', '1024x gtceu:borax_dust', '1024x gtceu:borax_dust'], [6500, 3300, 3300, 6500], [850, 0, 0, 850], 4)
    ...
    sift('nether_quartz', '128x #forge:raw_materials/nether_quartz', 'minecraft:water', ['512x gtceu:stone_dust'], ['128x gtceu:quartzite_gem', '128x gtceu:stone_dust', '512x gtceu:quartzite_dust', '512x gtceu:exquisite_nether_quartz_gem', '512x gtceu:flawless_nether_quartz_gem', '512x minecraft:quartz', '512x gtceu:pure_nether_quartz_dust'], [2800, 1100, 3300, 900, 1900, 6500, 9500], [300, 100, 0, 100, 150, 500, 750], 2)
    sift('nether_quartz_silked', '128x #forge:ores/nether_quartz', 'minecraft:water', ['1152x gtceu:stone_dust'], ['128x gtceu:quartzite_gem', '1024x gtceu:quartzite_dust', '1024x gtceu:exquisite_nether_quartz_gem', '1024x gtceu:flawless_nether_quartz_gem', '1024x minecraft:quartz', '1024x gtceu:pure_nether_quartz_dust'], [2800, 3300, 900, 1900, 6500, 9500], [300, 100, 0, 100, 150, 500, 750], 4)
    ...
    // pyrochlore
    process('pyrochlore', '128x #forge:raw_materials/pyrochlore', 'minecraft:water', ['256x gtceu:pyrochlore_dust', '256x gtceu:stone_dust'], ['128x gtceu:apatite_gem', '128x gtceu:stone_dust', '256x gtceu:apatite_dust', '256x gtceu:calcium_dust', '256x gtceu:niobium_dust'], [2800, 1100, 3300, 3300, 6500], [300, 100, 0, 0, 850], 1)
    process('pyrochlore_silked', '128x #forge:ores/pyrochlore', 'minecraft:water', ['512x gtceu:pyrochlore_dust', '640x gtceu:stone_dust'], ['128x gtceu:apatite_gem', '512x gtceu:apatite_dust', '512x gtceu:calcium_dust', '512x gtceu:niobium_dust'], [6500, 3300, 3300, 6500], [850, 0, 0, 850], 2)
    ...
    sift('apatite', '128x #forge:raw_materials/apatite', 'minecraft:water', ['1024x gtceu:stone_dust'], ['128x gtceu:tricalcium_phosphate_dust', '128x gtceu:stone_dust', '1024x gtceu:tricalcium_phosphate_dust', '1024x gtceu:exquisite_apatite_gem', '1024x gtceu:flawless_apatite_gem', '1024x gtceu:apatite_gem', '1024x gtceu:pure_apatite_dust'], [2800, 1100, 3300, 900, 1900, 6500, 9500], [300, 100, 0, 100, 150, 500, 750], 4)
    sift('apatite_silked', '128x #forge:ores/apatite', 'minecraft:water', ['2176x gtceu:stone_dust'], ['128x gtceu:tricalcium_phosphate_dust', '2048x gtceu:tricalcium_phosphate_dust', '2048x gtceu:exquisite_apatite_gem', '2048x gtceu:flawless_apatite_gem', '2048x gtceu:apatite_gem', '2048x gtceu:pure_apatite_dust'], [2800, 3300, 900, 1900, 6500, 9500], [300, 100, 0, 100, 150, 500, 750], 8)
    
    // tricalcium phosphate
    process('tricalcium_phosphate', '128x #forge:raw_materials/tricalcium_phosphate', 'minecraft:water', ['768x gtceu:tricalcium_phosphate_dust', '768x gtceu:stone_dust'], ['128x gtceu:apatite_gem', '128x gtceu:stone_dust', '768x gtceu:apatite_dust', '768x gtceu:phosphate_dust', '768x gtceu:pyrochlore_dust'], [2800, 1100, 3300, 3300, 6500], [300, 100, 0, 0, 850], 3)
    process('tricalcium_phosphate_silked', '128x #forge:ores/tricalcium_phosphate', 'minecraft:water', ['1536x gtceu:tricalcium_phosphate_dust', '1664x gtceu:stone_dust'], ['128x gtceu:apatite_gem', '1536x gtceu:apatite_dust', '1536x gtceu:phosphate_dust', '1536x gtceu:pyrochlore_dust'], [6500, 3300, 3300, 6500], [850, 0, 0, 850], 6)
